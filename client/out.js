...
(function dartProgram() {
  ...
  F = {
    request: function() {
      var t1 = $.__request;
      return t1 == null ? H.throwExpression(H.LateError$fieldNI("request")) : t1;
    },
    main: function() {
      var t1 = document,
        t2 = type$.AnchorElement;
      $.__time = t2._as(t1.querySelector("#time"));
      $.__resume = t2._as(t1.querySelector("#resume"));
    ...
    setupResume: function() {
      var t2, t3,
        t1 = $.__resume;
      if (t1 == null)
        t1 = H.throwExpression(H.LateError$fieldNI("resume"));
      t2 = type$._ElementEventStreamImpl_MouseEvent;
      t3 = t2._eval$1("~(1)?")._as(new F.setupResume_closure());
      type$.nullable_void_Function._as(null);
      W._EventStreamSubscription$(t1, "click", t3, false, t2._precomputed1);
    },
    setupTime: function() {
      var t2, t3,
        t1 = $.__time;
      if (t1 == null)
        t1 = H.throwExpression(H.LateError$fieldNI("time"));
      t2 = type$._ElementEventStreamImpl_MouseEvent;
      t3 = t2._eval$1("~(1)?")._as(new F.setupTime_closure());
      type$.nullable_void_Function._as(null);
      W._EventStreamSubscription$(t1, "click", t3, false, t2._precomputed1);
    },
    setupResume_closure: function setupResume_closure() {
    },
    setupTime_closure: function setupTime_closure() {
    }
  };
  ...
  H.ListIterable.prototype = {
    get$iterator: function(_) {
      var t1 = this._parent;
      return new H.ListIterator(this, t1.get$length(t1), H._instanceType(this)._eval$1("ListIterator<ListIterable.E>"));
    }
  };
  ...
  F.setupResume_closure.prototype = {
    call$1: function($event) {
      type$.MouseEvent._as($event);
      C.HttpRequest_methods.open$2(F.request(), "GET", "http://127.0.0.1:4040/resume");
      F.request().send();
    },
    $signature: 18
  };
  F.setupTime_closure.prototype = {
    call$1: function($event) {
      return this.$call$body$setupTime_closure(type$.MouseEvent._as($event));
    },
    $call$body$setupTime_closure: function($event) {
      var $async$goto = 0,
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return P._asyncAwait(W.HttpRequest_getString("http://127.0.0.1:4040/time"), $async$call$1);
            case 2:
              // returning from await.
              data = $async$temp1.decode$1(0, $async$result);
              C.Window_methods.alert$1(window, "Server Date-Time is " + H.S(J.$index$as(data, "server-time")));
              // implicit return
  ...
  var init = {
    ...
    metadata: [],
    types: ["~()", "~(~())", "Null(@)", "Null()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "~(@)", "Null(@,StackTrace)", "~(int,@)", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "String(HttpRequest)", "~(ProgressEvent)", "~(Event)", "~(MouseEvent)", "Future<~>(MouseEvent)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","JavaScriptFunction":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"Element","GraphicsElement":"Element","SvgElement":"Element","_ResourceProgressEvent":"ProgressEvent","AudioElement":"HtmlElement","MediaElement":"HtmlElement","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","HtmlDocument":"Node","Document":"Node","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSDouble":{"num":[]},"JSString":{"String":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"AsyncError":{"Error":[]},"_AsyncCompleter":{"_Completer":["1"]},"_Future":{"Future":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"MapBase":{"MapMixin":["1","2"]},"_JsonMap":{"MapMixin":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"Iterable":["String"],"ListIterable.E":"String"},"JsonCodec":{"Codec":["Object?","String"]},"JsonDecoder":{"Converter":["String","Object?"]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"HtmlElement":{"Element":[],"EventTarget":[]},"AnchorElement":{"Element":[],"EventTarget":[]},"AreaElement":{"Element":[],"EventTarget":[]},"Element":{"EventTarget":[]},"FormElement":{"Element":[],"EventTarget":[]},"HttpRequest":{"EventTarget":[]},"HttpRequestEventTarget":{"EventTarget":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"ProgressEvent":{"Event":[]},"SelectElement":{"Element":[],"EventTarget":[]},"UIEvent":{"Event":[]},"Window":{"EventTarget":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]}}'));
